        ...
        updateLastControl: function (callback2) {
            if (vPunto) {
                ...
                if (!vPunto.lastcontrol) {
                    ...
                    if (vPunto.lastcontrol < vLastControl) sPunto.lastcontrol = vLastControl;
                }
