...
module.exports.deleteTables = function(callback) {
    ...
    var input = {
        ...
        db: config.cn50sdfExport + "terminal.sdf",
        pass: '',
        value: ''
    };
...
module.exports.postAdministrador = function(administrador, callback) {
    ...
    netLib(s, function(err, result) {
        ...
        console.log("RES: Administrador" + result);
        // specific error
        if (result.indexOf('ERROR') > -1) {
            var error = new Error(result);
            callback(error, null);
...
module.exports.getDescargasLineas = function(file, terminalId, callback) {
    var netLib = edge.func({
        assemblyFile: 'TermCN50Lib.dll',
        typeName: 'TermCN50Lib.CN50DescargasLineas',
        methodName: 'Invoke'
    });
    var input = {
        command: "GetDescargasLineas",
        db: config.cn50sdfImport + file,
        pass: '',
        value: ''
    };
    var s = JSON.stringify(input);
