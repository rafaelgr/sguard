...
module.exports.getRondas = function(dfecha, hfecha, dhora, hhora, callback) {
    ...
    sql += " rrp.ordenleido, rrp.orden AS ordenronda, rrp.tagleido, p.nombre AS punto, rrp.fecha, rrp.hora, rrp.resultado, COALESCE(i.nombre, '') as incidencia, rrp.observaciones";
...
module.exports.getGeneralExcel = function(ronda, vigilante, terminal, dfecha, hfecha, dhora, hhora, callback) {
    ...
    sql += " rp.orden, rp.ordenleido, rp.fecha AS fechap, rp.hora AS horap, rp.resultado AS resultadop, COALESCE(i.nombre, '') as incidencia, rp.observaciones";
    sql += " FROM rondas_realizadas AS rr";
